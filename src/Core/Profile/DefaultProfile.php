...
use AliyunOpenApi\Core\Auth\AbstractCredential;
use AliyunOpenApi\Core\Auth\BearerTokenCredential;
use AliyunOpenApi\Core\Auth\BearTokenSigner;
use AliyunOpenApi\Core\Auth\Credential;
use AliyunOpenApi\Core\Auth\EcsRamRoleCredential;
use AliyunOpenApi\Core\Auth\ISigner;
use AliyunOpenApi\Core\Auth\RamRoleArnCredential;
use AliyunOpenApi\Core\Auth\ShaHmac1Signer;
use AliyunOpenApi\Core\Regions\Endpoint;
use AliyunOpenApi\Core\Regions\EndpointProvider;
use AliyunOpenApi\Core\Regions\LocationService;
use AliyunOpenApi\Core\Regions\ProductDomain;
